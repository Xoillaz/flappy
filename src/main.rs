...
impl Player {
    ...
    fn render(&mut self, ctx: &mut BTerm) {
        // to_cp437(): match Codepage 437 character number.
...
impl State {
    ...
    fn play(&mut self, ctx: &mut BTerm) {
        // Specify bg_color with navy blue.
        ctx.cls_bg(NAVY);
    ...
    fn main_menu(&mut self, ctx: &mut BTerm) {
        ctx.cls();
        ctx.print_centered(23, "Welcome to Flappy");
        ctx.print_centered(26, "(P) Play Game");
    ...
    fn dead(&mut self, ctx: &mut BTerm) {
        ctx.cls();
        ctx.print_centered(23, "You are dead!");
        ctx.print_centered(24, &format!("You earned {} points", self.score));
        ctx.print_centered(26, "(P) Play Again");
        ctx.print_centered(27, "(Q) Quit Game");
